...
2. **Discovery**: It identifies all branches with open or draft PRs
...
1. You have a release branch `release/v1.0` with an open PR
2. You merge a bug fix PR into `master`
3. The workflow automatically:
   - Detects that `release/v1.0` has an open PR
...
Verify that:
- The branch has an open or draft PR
